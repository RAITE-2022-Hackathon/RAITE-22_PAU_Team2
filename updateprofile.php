...
<body id="page-top">
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Valerie Luna</span><img class="border rounded-circle img-profile" src="assets/img/avatars/avatar1.jpeg"></a>
                                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in"><a class="dropdown-item" href="#"><i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;User</a><a class="dropdown-item" href="#"><i ></a>
  ...
  <label for="fname">New Profile Name</label>
    <input type="text" id="fname" name="firstname" placeholder="Enter your new profile name">

    <label for="fname">New Email</label>
    <input type="text" id="fname" name="firstname" placeholder="Enter your new email">

    <label for="lname">New Password</label>
    <input type="text" id="lname" name="lastname" placeholder="Enter your new password">
